...
window.TEACHME_LESSONS = {
  ...
  4: ['angle', 'angle-shape', 'area', 'chain-divide', 'chart', 'congruent', 'cubes', 'decimal', 'figurate', 'fraction', 'multiply-divide', 'numbers', 'pattern', 'perpendicular', 'quadrilateral', 'rounding', 'time', 'triangle'],
