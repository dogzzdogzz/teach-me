...
window.TEACHME_LESSONS = {
  ...
  4: ['angle', 'angle-shape', 'area', 'chart', 'congruent', 'cubes', 'decimal', 'figurate', 'fraction', 'multiply-divide', 'numbers', 'pattern', 'perpendicular', 'quadrilateral', 'rounding', 'time', 'triangle'],
