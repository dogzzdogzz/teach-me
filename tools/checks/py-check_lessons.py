...
BREAKS = [
    ...
    dict(file='lessons.js', expect='[UNREGISTERED]',
         find="  4: ['angle', 'area', 'decimal', 'fraction', 'multiply-divide', 'numbers', 'pattern', 'quadrilateral', 'rounding', 'time', 'triangle'],",
         replace="  4: ['angle', 'area', 'numbers', 'rounding', 'time'],"),
    # lessons.js 登記了、磁碟上沒有
    dict(file='lessons.js', expect='[GHOST]',
         find="  4: ['angle', 'area', 'decimal', 'fraction', 'multiply-divide', 'numbers', 'pattern', 'quadrilateral', 'rounding', 'time', 'triangle'],",
         replace="  4: ['angle', 'area', 'decimal', 'fraction', 'ghost-lesson', 'multiply-divide', 'numbers', 'pattern', 'quadrilateral', 'rounding', 'time', 'triangle'],"),
    # 年級頁的課程卡數對不上實際堂數
